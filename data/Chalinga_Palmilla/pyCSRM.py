...
def DEVELOP_SRM(root, Basin, alpha, Tcrit, plots):
    ...
    if plots:
        ...
        # SWe observado
        swe_obs = pd.read_csv(r'E:\CIREN\OneDrive - ciren.cl\Ficha_16_Coquimbo\02_SIG\02_Aguas sup\04_Regional\cuencas_cabecera\Rio Chalinga En La Palmilla\SWE_bands_ERA5h.csv', index_col = 0, parse_dates = True)
